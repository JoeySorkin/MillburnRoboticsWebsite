...
export default function ContactUs() {
  ...
  const sendForm = () => {
    ...
    xhr.open("POST", "https://millburnroboticsapiv2.herokuapp.com/", true);
    xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    xhr.send(`name=${name}&email=${email}&content=${message}`);
  };
      ...
      <Paper elevation={4} className={classes.paper}>
        <Container className={classes.root}>
          <Snackbar open={open} autoHideDuration={5000} onClose={handleClose}>
            <Alert
              onClose={handleClose}
              severity={snackbarTrue ? "success" : "error"}
            >
              {snackbarTrue
          ...
          <div className={classes.formbox}>
            <Paper className={classes.papercell}>
              ...
              <TextField
                ...
                error={!emailValidity}
                helperText={
                  !emailValidity ? "Please enter a valid email " : null
                }
              />
              <br />
              <TextField
          ...
          <div className={classes.formbox} style={{ flex: 1 }}>
            ...
            >
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <Button
                  target="_blank"
                  href="https://www.instagram.com/7405_millburnrobotics/?hl=en"
                  variant="outlined"
                  size="large"
                  style={{ color: colors.white, background: colors.pink }}
                ...
                <Button
                  target="_blank"
                  href="mailto:millburn7405k@gmail.com"
                  variant="outlined"
                  size="large"
                ...
                <Button
                  target="_blank"
                  href="https://github.com/Millburn-Robotics"
                  variant="outlined"
                  size="large"
                  className={classes.socialbtn}
